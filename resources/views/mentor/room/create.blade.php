...
@section('content')
    <div class="max-w-4xl mx-auto">
        {{-- HEADER PAGE --}}
        <div class="mb-6">
            <p class="text-xs font-semibold uppercase tracking-wide text-white mb-1">
                Mentor Room
            </p>
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-2 text-sm text-white max-w-xl">
                        Atur detail kelas yang ingin kamu buka, mulai dari tipe room, mode belajar,
                        jadwal, hingga persyaratan untuk peserta.
                    </p>
                </div>
                <div class="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-50 border border-teal-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="title" class="flex items-center justify-between mb-1.5">
                        <span class="text-sm font-semibold text-gray-800">Judul Room</span>
                ...
                {{-- TIPE ROOM --}}
                <div>
                    <label for="type_id" class="block text-sm font-semibold text-gray-800 mb-1.5">
                        Tipe Room
                    </label>
                ...
                {{-- MODE ROOM --}}
                <div>
                    <label for="mode" class="block text-sm font-semibold text-gray-800 mb-1.5">
                        Mode Room
                    </label>
                ...
                <div class="md:col-span-2"
                    ...
                    <label for="location" class="block text-sm font-semibold text-gray-800 mb-1.5">
                ...
                {{-- WAKTU MULAI --}}
                <div>
                    <label for="started_at" class="block text-sm font-semibold text-gray-800 mb-1.5">
                        Waktu Mulai
                    </label>
                ...
                {{-- WAKTU SELESAI --}}
                <div>
                    <label for="end_at" class="block text-sm font-semibold text-gray-800 mb-1.5">
                        Waktu Selesai
                    </label>
                ...
                <div class="md:col-span-2">
                    <label for="description" class="flex items-center justify-between mb-1.5">
                        <span class="text-sm font-semibold text-gray-800">Deskripsi Singkat</span>
                    </label>
                ...
                {{-- PERSYARATAN --}}
                <div class="md:col-span-2">
                    <label for="requirements" class="block text-sm font-semibold text-gray-800 mb-1.5">
                        Persyaratan
                    </label>
