    ...
    <form action="{{ route('mentor.rooms.posts.update', [$room, $post]) }}" method="POST"
        ...
        <div class="mb-6">
            ...
            <textarea id="content" name="content" rows="10"
                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 resize-none"
                placeholder="Jelaskan apa yang akan dipelajari di room ini...">{{ old('content' ,$post->content) }}</textarea>
        </div>
